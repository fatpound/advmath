...
class DualOrderedCubeScene : public Scene
{
public:
    DualOrderedCubeScene()
        :
        Scene(L"Dual Cube Ordered")
    {
...
public:
    ...
    virtual void Draw(Graphics& gfx) const override
    {
        ...
        //      FIXED CUBE
        {
            const Maf3 rot = Maf3::RotationAroundX(theta_x) * Maf3::RotationAroundY(theta_y + dTheta) * Maf3::RotationAroundZ(theta_z);
